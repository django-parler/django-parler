...
class InlineFormTests(AppTestCase):
    def test_integer_primary_key(self):
        ...
        InlineFormSet = inlineformset_factory(
            IntegerPrimaryKeyModel, IntegerPrimaryKeyRelatedModel, fields=()
        )
        formset = InlineFormSet(
            instance=parent, data={"children-TOTAL_FORMS": 1, "children-INITIAL_FORMS": 0}
        )
    ...
    def test_uuid_primary_key(self):
        ...
        InlineFormSet = inlineformset_factory(
            UUIDPrimaryKeyModel, UUIDPrimaryKeyRelatedModel, fields=()
        )
        formset = InlineFormSet(
            instance=parent, data={"children-TOTAL_FORMS": 1, "children-INITIAL_FORMS": 0}
        )
