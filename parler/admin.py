...
class TranslatableAdmin(BaseTranslatableAdmin, admin.ModelAdmin):
    ...
    def get_available_languages(self, obj):
        ...
        if obj:
            ...
            return self.model._parler_meta.translations_model.objects.none()
    ...
    def delete_translation(self, request, object_id, language_code):
        ...
        """
        opts = self.model._meta
        translations_model = self.model._parler_meta.translations_model
    ...
    def _get_inline_translations(self, request, language_code, obj=None):
        ...
        for inline in inline_instances:
            if issubclass(inline.model, TranslatableModel):
                ...
                qs = inline.model._parler_meta.translations_model.objects.filter(**filters)
                if obj is not None:
...
class TranslatableInlineModelAdmin(BaseTranslatableAdmin, InlineModelAdmin):
    ...
    def get_available_languages(self, obj, formset):
        ...
        if obj:
            ...
            return self.model._parler_meta.translations_model.objects.using(obj._state.db).filter(**filter) \
